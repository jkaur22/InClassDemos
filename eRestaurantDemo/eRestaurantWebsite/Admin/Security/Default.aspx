...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <%--List of Waiters--%>
    <asp:ObjectDataSource runat="server" ID="WaiterDataSource" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllWaiters" TypeName="eRestaurantSystem.BLL.AdminController"></asp:ObjectDataSource>

    <asp:ListView ID="UserListView" runat="server"
    ItemType="eRestaurantSystem.Entities.Security.ApplicationUser"
