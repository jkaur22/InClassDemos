...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
                    ...
                    <asp:TemplateField HeaderText="Reservation Notes / Seat Walk-In">
                        <ItemTemplate>
                            ...
                            <asp:Panel ID="OccupiedTablePanel" runat="server"
                                    Visible='<%# Item.Taken  %>'>
                                <asp:HyperLink ID="ServingTablesLink" runat="server" NavigateUrl='<%# string.Format("~/UXPages/ServingTables.aspx?waiter={0}&bill={1}&md={2}&mt={3}&mds={4}&mts={5}",Item.Waiter,
                                Item.BillID, Mocker.MockDate.Ticks,Mocker.MockTime.Ticks, Mocker.MockDate.ToShortDateString(),Mocker.MockTime.ToString()) %>'>
   ...
   <%-- <asp:ObjectDataSource runat="server" ID="ObjectDataSource1" OldValuesParameterFormatString="original_{0}" SelectMethod="SeatingByDateTime" TypeName="eRestaurant.BLL.SeatingController">
        <SelectParameters>
    ...
    <!-- this is the presentation mark up code for the reservation display.
     ...
     <div class="pull-right col-md-5">
        ...
        <details open>
             <!-- the text displayed beside the detail icon which is a black triangle -->
